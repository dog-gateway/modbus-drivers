 ...
 * 
 */
public class ModbusThreePhaseElectricityMeterDriverInstance
        extends ModbusDriverInstance implements ThreePhaseElectricityMeter
{
    // the class logger
    private Logger logger;

    public ModbusThreePhaseElectricityMeterDriverInstance(ModbusNetwork network,
            ...
            ServiceReference<Device> device)
    {
        ...
        this.logger = context
                ...
                .getLogger(
                        ModbusThreePhaseElectricityMeterDriverInstance.class);
    ...
    private void initializeStates()
    {
        ...
        frequencyStateValue
                .setValue(DecimalMeasure.valueOf("0 " + frequencyUOM));
        this.currentState.setState(
                FrequencyMeasurementState.class.getSimpleName(),
                new FrequencyMeasurementState(frequencyStateValue));
        // -----------------------------------------------------------------
        ...
        this.currentState.setState(
                ...
                new SinglePhaseActiveEnergyState(
                        new StateValue[] { activeEnergyStateValue }));
        // ------------------------------------------------------------------
        ...
        this.currentState.setState(ThreePhaseCurrentState.class.getSimpleName(),
                new ThreePhaseCurrentState(currentStateL1, currentStateL2,
                        currentStateL3));
        // -------------------------------------------------------------------
        ...
        this.currentState.setState(
                ...
                new ThreePhaseReactivePowerMeasurementState(
                        reactivePowerStateL1, reactivePowerStateL2,
                        reactivePowerStateL3));
        // --------------------------------------------------------------------
        ...
        this.currentState.setState(
                ...
                new ThreePhaseApparentPowerMeasurementState(
                        apparentPowerStateL1, apparentPowerStateL2,
                        apparentPowerStateL3));
        // ----------------------------------------------------------------------
        ...
        reactiveEnergyStateValue
                .setValue(DecimalMeasure.valueOf("0 " + reactiveEnergyUOM));
        this.currentState.setState(
                SinglePhaseReactiveEnergyState.class.getSimpleName(),
                new SinglePhaseReactiveEnergyState(
                        new StateValue[] { reactiveEnergyStateValue }));
        // -----------------------------------------------------------------------
        ...
        this.currentState.setState(ThreePhaseVoltageState.class.getSimpleName(),
                new ThreePhaseVoltageState(voltageStateL12, voltageStateL23,
                        voltageStateL31, voltageStateL1N, voltageStateL2N,
                        voltageStateL3N));
