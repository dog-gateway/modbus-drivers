 ...
 * 
 */
public class ModbusHumiditySensorDriver implements Driver
{
	...
	public static String logId = "[ModbusHumiditySensorDriver]: ";
	...
	private Vector<ModbusHumiditySensorDriverInstance> connectedDrivers;
	...
	public void activate(BundleContext context)
	{
		...
		this.connectedDrivers = new Vector<ModbusHumiditySensorDriverInstance>();
	...
	{
		// log deactivation
		this.logger.log(LogService.LOG_DEBUG, ModbusHumiditySensorDriver.logId + " Deactivation required");
	...
	public int match(ServiceReference reference) throws Exception
	{
		...
		if ((this.network != null) && (this.gateway != null) && (this.regDriver != null))
		{
			...
			try
			{
				...
				if (Controllable.class.isAssignableFrom(ModbusHumiditySensorDriver.class.getClassLoader().loadClass(
						deviceCategory)))
				{
					...
					if (deviceCategory != null)
					{
						if (manufacturer != null
								...
								&& (deviceCategory.equals(HumiditySensor.class.getName()) && (this.gateway
										.isGatewayAvailable(gateway))
								
								))
						{
							matchValue = HumiditySensor.MATCH_MANUFACTURER + HumiditySensor.MATCH_TYPE;
						}
	...
	public String attach(ServiceReference reference) throws Exception
	{
		...
		{	
			synchronized (this.connectedDrivers)
			{
				...
				ModbusHumiditySensorDriverInstance driverInstance = new ModbusHumiditySensorDriverInstance(network,
	...
	private void register()
	{
		if ((this.network != null) && (this.gateway != null) && (this.context != null) && (this.regDriver == null))
		{
			...
			propDriver.put(DeviceCostants.DRIVER_ID, ModbusHumiditySensorDriver.class.getName());
