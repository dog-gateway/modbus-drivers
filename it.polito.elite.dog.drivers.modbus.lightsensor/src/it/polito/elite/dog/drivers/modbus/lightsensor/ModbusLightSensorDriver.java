 ...
 * 
 */
public class ModbusLightSensorDriver implements Driver
{
	...
	public static String logId = "[ModbusLightSensorDriver]: ";
	...
	private Vector<ModbusLightSensorDriverInstance> connectedDrivers;
	...
	public void activate(BundleContext context)
	{
		...
		this.connectedDrivers = new Vector<ModbusLightSensorDriverInstance>();
	...
	{
		// log deactivation
		this.logger.log(LogService.LOG_DEBUG, ModbusLightSensorDriver.logId + " Deactivation required");
	...
	public int match(ServiceReference reference) throws Exception
	{
		...
		if ((this.network != null) && (this.gateway != null) && (this.regDriver != null))
		{
			...
			try
			{
				...
				if (Controllable.class.isAssignableFrom(ModbusLightSensorDriver.class.getClassLoader().loadClass(
						deviceCategory)))
				{
					...
					if (deviceCategory != null)
					{
						if (manufacturer != null
								...
								&& (deviceCategory.equals(LightSensor.class.getName()) && (this.gateway
										.isGatewayAvailable(gateway))
								
								))
						{
							matchValue = LightSensor.MATCH_MANUFACTURER + LightSensor.MATCH_TYPE;
						}
	...
	public String attach(ServiceReference reference) throws Exception
	{
		if (this.regDriver != null)
		{
			synchronized (this.connectedDrivers)
			{
				...
				ModbusLightSensorDriverInstance driverInstance = new ModbusLightSensorDriverInstance(network,
	...
	private void register()
	{
		if ((this.network != null) && (this.gateway != null) && (this.context != null) && (this.regDriver == null))
		{
			...
			propDriver.put(DeviceCostants.DRIVER_ID, ModbusLightSensorDriver.class.getName());
