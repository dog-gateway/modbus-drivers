...
/**
 * RegXlator for LITTLE ENDIAN INT32 Input Registers (backward compatibility)
 * 
 ...
 * @since May 28, 2013
 */
public class RegXlator4ByteIntegerInput extends BaseRegXlator
{
    ...
    {
        super(DataSizeEnum.INT32, RegisterTypeEnum.INPUT_REGISTER,
