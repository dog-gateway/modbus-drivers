...
/**
 * 
 * A class for representing the driver of a Modbus co2 sensor.
 * 
 * @author <a href="mailto:dario.bonino@polito.it">Dario Bonino</a>
 * @see <a href="http://elite.polito.it">http://elite.polito.it</a>
 * 
 */
public class ModbusCo2SensorDriver implements Driver
{
	...
	public static String logId = "[ModbusCo2SensorDriver]: ";
	...
	private Vector<ModbusCo2SensorDriverInstance> connectedDrivers;
	...
	public void activate(BundleContext context)
	{
		...
		this.connectedDrivers = new Vector<ModbusCo2SensorDriverInstance>();
	...
	{
		// log deactivation
		this.logger.log(LogService.LOG_DEBUG, ModbusCo2SensorDriver.logId + " Deactivation required");
		
		// unregister from the network driver
		for (ModbusCo2SensorDriverInstance instance : this.connectedDrivers)
	...
	public int match(ServiceReference reference) throws Exception
	{
		...
		if ((this.network != null) && (this.gateway != null) && (this.regDriver != null))
		{
			...
			try
			{
				...
				if (Controllable.class.isAssignableFrom(ModbusCo2SensorDriver.class.getClassLoader().loadClass(
						deviceCategory)))
				{
					...
					if (deviceCategory != null)
					{
						if (manufacturer != null
								...
								&& (deviceCategory.equals(Co2Sensor.class.getName()) && (this.gateway
										.isGatewayAvailable(gateway))))
						{
							matchValue = Co2Sensor.MATCH_MANUFACTURER + Co2Sensor.MATCH_TYPE;
						}
	...
	public String attach(ServiceReference reference) throws Exception
	{
		if (this.regDriver != null)
		{
			synchronized (this.connectedDrivers)
			{
				...
				ModbusCo2SensorDriverInstance driverInstance = new ModbusCo2SensorDriverInstance(network,
	...
	private void register()
	{
		if ((this.network != null) && (this.gateway != null) && (this.context != null) && (this.regDriver == null))
		{
			...
			propDriver.put(DeviceCostants.DRIVER_ID, ModbusCo2SensorDriver.class.getName());
