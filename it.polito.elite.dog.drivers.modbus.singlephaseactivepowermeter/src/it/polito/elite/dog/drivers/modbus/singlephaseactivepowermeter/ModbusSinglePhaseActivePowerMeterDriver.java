...
public class ModbusSinglePhaseActivePowerMeterDriver implements Driver
{
	...
	public int match(ServiceReference reference) throws Exception
	{
		...
		if ((this.network != null) && (this.gateway != null) && (this.regDriver != null))
		{
			...
			try
			{
				...
				if (Controllable.class.isAssignableFrom(ModbusSinglePhaseActivePowerMeterDriver.class.getClassLoader()
	...
	private void register()
	{
		if ((this.network != null) && (this.gateway != null) && (this.context != null) && (this.regDriver == null))
		{
			...
			propDriver.put(DeviceCostants.DRIVER_ID, ModbusSinglePhaseActivePowerMeterDriver.class.getName());
